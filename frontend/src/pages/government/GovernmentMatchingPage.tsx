                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-4 border-b border-slate-100">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    {correspondingApp ? (
                      ...
                      <span className="text-xs text-slate-400 italic">No direct application submitted yet</span>
                    )}
                  </div>
                </div>
                  ...
                  <div className="space-y-3 bg-slate-50 p-3.5 rounded-xl border border-slate-200/80">
                    <div>
                      <h4 className="text-xs font-bold uppercase tracking-wider text-slate-500 mb-1.5">
                        Matched KPIs & Benchmark Capabilities
                      </h4>
                      <div className="flex flex-wrap gap-1.5">
                        {match.matched_kpis?.length > 0 ? (
                          match.matched_kpis.map((kpi, i) => (
                            <span
                              key={i}
                              className="px-2 py-0.5 rounded-md text-[11px] font-semibold bg-emerald-100 text-emerald-800"
                            >
                              ✓ {kpi}
                            </span>
                          ))
